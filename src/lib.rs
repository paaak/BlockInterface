// src/lib.rs
/*
 * Core library for BlockInterface
 */
...
#[derive(Debug)]
pub struct BlockInterfaceProcessor {
    verbose: bool,
    processed_count: usize,
}

impl BlockInterfaceProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting BlockInterface processing");
    
    let mut processor = BlockInterfaceProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = BlockInterfaceProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = BlockInterfaceProcessor::new(false);
